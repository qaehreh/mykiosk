  ...
  data() {
    ...
    return {
      ...
      products: [
        ...
        { id: 8, name: "고구마라떼", price: 10000,category:"음료", image:"../../public/image/drink/고구마라떼(ICED).png"},
        { id: 9, name: "녹차프라푸치노", price: 54003, category:"음료", image:"../../public/image/drink/녹차프라푸치노.png" },
        { id: 10, name: "오곡라떼", price: 1003 , category: "음료", image:"../../public/image/drink/오곡라떼(ICED).png"  },
        { id: 11, name: "초코젤라또프라푸치노", price: 40001, category: "음료", image:"../../public/image/drink/초코젤라또프라푸치노.png"  },
        { id: 12, name: "타로버블티", price: 30000 , category: "음료", image:"../../public/image/drink/타로버블티.png"  },
        { id: 13, name: "흑당버블티", price: 20000 , category: "음료", image:"../../public/image/drink/흑당버블티.png"  },
        { id: 14, name: "블랙밀크버블티", price: 8000 , category: "음료", image:"../../public/image/drink/블랙밀크버블티.png"  },
        { id: 15, name: "아쌈", price: 2000,category: "음료", image:"../../public/image/tea/아쌈.png" },
        { id: 16, name: "아이스티", price: 100 ,category: "음료", image:"../../public/image/tea/아이스티.png" },
